...
public class HealthCheckTest : IClassFixture<TestHttpClient<Program, Demo.API.Program>>
{
    private readonly TestHttpClient<Program, Demo.API.Program> _httpClient;

    public HealthCheckTest(TestHttpClient<Program, Demo.API.Program> httpClient)
    {
